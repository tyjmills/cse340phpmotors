...
/* ***************************
 *  Get inventory item info inventory_id
 * ************************** */
...
async function registerNewVehicle (inv_make, inv_model, inv_year, inv_description, inv_image, inv_thumbnail, inv_price, inv_miles, inv_color, classification_id){
  ...
  module.exports = {getClassifications, getInventoryByClassificationId, getInventory, getInventoryByInventoryId, registerNewClassification, registerNewVehicle};
